...
export const Plane_line_Icon = () => {
  return (
    <svg
      ...
      stroke_width="1.5"
      stroke="currentColor"
      className="icon icon-plane-line"
    >
      <path
        stroke_linecap="round"
        stroke_linejoin="round"
...
export const Profile_line_Icon = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
